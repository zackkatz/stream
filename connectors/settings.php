...
class WP_Stream_Connector_Settings extends WP_Stream_Connector {
	...
	public static function get_context_labels() {
		$context_labels = array(
			...
			'custom_background ' => __( 'Custom Background' ),
			'custom_header'      => __( 'Custom Header' ),
		);
	...
	public static function get_field_label( $field_key ) {
		$labels = array(
			...
			'admin_email'                   => __( 'E-mail Address' ),
			'users_can_register'            => __( 'Membership' ),
			'default_role'                  => __( 'New User Default Role' ),
			'timezone_string'               => __( 'Timezone' ),
			'date_format'                   => __( 'Date Format' ),
			'time_format'                   => __( 'Time Format' ),
			'start_of_week'                 => __( 'Week Starts On' ),
			// Writing
			'use_smilies'                   => __( 'Formatting' ),
			'use_balanceTags'               => __( 'Formatting' ),
			'default_category'              => __( 'Default Post Category' ),
			'default_post_format'           => __( 'Default Post Format' ),
			'mailserver_url'                => __( 'Mail Server Address' ),
			'mailserver_login'              => __( 'Mail Server Login Name' ),
			'mailserver_pass'               => __( 'Mail Server Password' ),
			'default_email_category'        => __( 'Default Mail Category' ),
			'ping_sites'                    => __( 'Update Services' ),
			// Reading
			'show_on_front'                 => __( 'Front page displays' ),
			'page_on_front'                 => __( 'Front page displays' ),
			'page_for_posts'                => __( 'Front page displays' ),
			'posts_per_page'                => __( 'Blog pages show at most' ),
			'posts_per_rss'                 => __( 'Syndication feeds show the most recent' ),
			'rss_use_excerpt'               => __( 'For each article in a feed, show' ),
			'blog_public'                   => __( 'Search Engine Visibility' ),
			// Discussion
			'default_pingback_flag'         => __( 'Default article settings' ),
			'default_ping_status'           => __( 'Default article settings' ),
			'default_comment_status'        => __( 'Default article settings' ),
			'require_name_email'            => __( 'Other comment settings' ),
			'comment_registration'          => __( 'Other comment settings' ),
			'close_comments_for_old_posts'  => __( 'Other comment settings' ),
			'close_comments_days_old'       => __( 'Other comment settings' ),
			'thread_comments'               => __( 'Other comment settings' ),
			'thread_comments_depth'         => __( 'Other comment settings' ),
			'page_comments'                 => __( 'Other comment settings' ),
			'comments_per_page'             => __( 'Other comment settings' ),
			'default_comments_page'         => __( 'Other comment settings' ),
			'comment_order'                 => __( 'Other comment settings' ),
			'comments_notify'               => __( 'E-mail me whenever' ),
			'moderation_notify'             => __( 'E-mail me whenever' ),
			'comment_moderation'            => __( 'Before a comment appears' ),
			'comment_whitelist'             => __( 'Before a comment appears' ),
			'comment_max_links'             => __( 'Comment Moderation' ),
			'moderation_keys'               => __( 'Comment Moderation' ),
			'blacklist_keys'                => __( 'Comment Blacklist' ),
			'show_avatars'                  => __( 'Avatar Display' ),
			'avatar_rating'                 => __( 'Avatar Maximum Rating' ),
			'avatar_default'                => __( 'Default Avatar' ),
			// Media
			'thumbnail_size_w'              => __( 'Thumbnail Image Size' ),
			'thumbnail_size_h'              => __( 'Thumbnail Image Size' ),
			'thumbnail_crop'                => __( 'Thumbnail Image Size' ),
			'medium_size_w'                 => __( 'Medium Image Size' ),
			'medium_size_h'                 => __( 'Medium Image Size' ),
			'large_size_w'                  => __( 'Large Image Size' ),
			'large_size_h'                  => __( 'Large Image Size' ),
			'uploads_use_yearmonth_folders' => __( 'Uploading Files Organization' ),
			// Permalinks
			'permalink_structure'           => __( 'Permalink structure' ),
			'category_base'                 => __( 'Category base' ),
			'tag_base'                      => __( 'Tag base' ),
			// Network
			'registrationnotification'      => __( 'Registration notification' ),
			'registration'                  => __( 'Allow new registrations' ),
			'add_new_users'                 => __( 'Add New Users' ),
			'menu_items'                    => __( 'Enable administration menus' ),
			'upload_space_check_disabled'   => __( 'Site upload space check' ),
			'blog_upload_space'             => __( 'Site upload space' ),
			'upload_filetypes'              => __( 'Upload file types' ),
			'site_name'                     => __( 'Network Title' ),
			'first_post'                    => __( 'First Post' ),
			'first_page'                    => __( 'First Page' ),
			'first_comment'                 => __( 'First Comment' ),
			'first_comment_url'             => __( 'First Comment URL' ),
			'first_comment_author'          => __( 'First Comment Author' ),
			'welcome_email'                 => __( 'Welcome Email' ),
			'welcome_user_email'            => __( 'Welcome User Email' ),
			'fileupload_maxk'               => __( 'Max upload file size' ),
			'global_terms_enabled'          => __( 'Terms Enabled' ),
			'illegal_names'                 => __( 'Banned Names' ),
			'limited_email_domains'         => __( 'Limited Email Registrations' ),
			'banned_email_domains'          => __( 'Banned Email Domains' ),
			'WPLANG'                        => __( 'Network Language' ),
	...
	public static function get_serialized_field_label( $option_name, $field_key ) {
		$labels = array(
			'theme_mods' => array(
				...
				'header_textcolor'       => __( 'Text Color' ),
			),
		);
